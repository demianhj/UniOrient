...
def run():
    ...
    input_dir = dir + '/G-objaverse_h5py_files'  # Directory containing input h5py files
    output_dir = dir + '/G-objaverse_h5py_files_rotated'  # Directory for output h5py files
