...
class ShapeProcessor:
    ...
    def load_dino_directory(self, h5py_files_path: str) -> DinoShapeData:
        ...
        try:
            ...
            feature_point_cloud_path = os.path.join(h5py_files_path, 'feature_models', 'dinov2_vits14')
...
# select_res_save_directory
    ...
    def export_cluster(self, cluster_id):
        ...
        try:
            ...
            # === 3. Save Rotation Data ===
            rotation_file = os.path.join(cluster_export_dir, f"{category_name}_cluster_{cluster_id}_rotations.json")
