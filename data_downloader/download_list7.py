...
if __name__=='__main__':
    ...
    for category, id_url_map in category_id_to_url.items():
        ...
        # armchair
        if category !='statue_(sculpture)': # armor # statue_(sculpture) # flower_arrangement # barrel # mushroom
            # vase #armchair # air_conditioner
            # new# doll # figurine # Lego # statue_(sculpture)
    ...
    # python data_downloader/download_list7.py
